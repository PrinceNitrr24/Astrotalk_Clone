      ...
      <footer className="bg-[#454545] ">
        <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <h1 className=" inline-block h1 text-white text-lg border-yellow-500 border-b-4">
                About Astrotalk
              </h1>
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
              <div className="text-center sm:text-left">
                <p className="text-lg font-medium text-white border-b-4 inline-block border-yellow-500">
                  Horoscope
                </p>
                ...
                <ul className="mt-8 space-y-4 text-sm">
                  ...
                  <li>
                    <Link
                      className="text-white transition text-[17px] inline-block border-b-4 border-yellow-500   hover:text-gray-300"
              ...
              <div className="text-center sm:text-left">
                <p className="text-lg font-medium border-b-4 inline-block border-yellow-500 text-white">
                  Important Links
                </p>
              ...
              <div className="text-center sm:text-left">
                <p className="text-lg font-medium text-white border-b-4 border-yellow-500 inline-block">
                  Important Links
                </p>
                ...
                <ul className="mt-8 space-y-4 text-sm">
                  ...
                  <li>
                    <Link
                      className="text-white transition hover:text-gray-300 border-b-4 border-yellow-500 inline-block text-[17px]"
                      style={{ paddingBottom: "5px" }}
                      href="#"
                    >
                      Astrologer
                  ...
                  <li>
                    <Link
                      className="text-white transition hover:text-gray-300  border-b-4 inline-block border-yellow-500"
                      style={{ paddingBottom: "5px" }}
                      href="#"
                    >
                      Corporate Info
              ...
              <div className="text-center sm:text-left">
                <p className="text-lg font-medium text-white inline-block border-b-4 border-yellow-500">
                  Corporate Info
                </p>
                ...
                <ul className="mt-8 space-y-4 text-sm">
                  ...
                  <li>
                    <Link
                      className="text-white transition hover:text-gray-300 border-b-4 border-yellow-500 inline-block"
                      style={{ paddingBottom: "5px" }}
                      href="#"
                    >
                      Contact Us
          ...
          <div className="mt-12 border-t border-gray-100 pt-6">
            <div className="text-center sm:flex sm:justify-between sm:text-left">
              <p className="text-sm text-white">
                ...
                <Link
                  className="inline-block text-gray-300 underline transition hover:text-gray-300"
                  href="#"
                >
                  Terms & Conditions
                </Link>
              ...
              <p className="mt-4 text-sm text-white sm:order-first sm:mt-0">
                Copyright 2023 Astrotalk Services Private Limited (Formerly
